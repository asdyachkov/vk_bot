"""
Django settings for vk_bot_admin project.
...
SECRET_KEY = (
    "django-insecure-*9o)^sd#+%q0l3z+$z+%pzc!re1*d-=+zu7_zsf9w21r(%(ai8"
)

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['.localhost', '127.0.0.1', '[::1]', '0.0.0.0', '95.163.241.174']
...
WSGI_APPLICATION = "vk_bot_admin.wsgi.application"
